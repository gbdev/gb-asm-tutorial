...
```rgbasm,linenos,start={{#line_no_of "" ../../unbricked/galactic-armada/main.asm:draw-text-typewriter}}
{{#include ../../unbricked/galactic-armada/main.asm:draw-text-typewriter}}
```
...
```rgbasm,linenos,start={{#line_no_of "" ../../unbricked/galactic-armada/main.asm:story-state}}
{{#include ../../unbricked/galactic-armada/main.asm:story-state}}
```
...
```rgbasm,linenos,start={{#line_no_of "" ../../unbricked/galactic-armada/main.asm:wait-for-key}}
{{#include ../../unbricked/galactic-armada/main.asm:wait-for-key}}
```