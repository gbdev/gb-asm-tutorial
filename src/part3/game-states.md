...
```rgbasm,linenos,start={{#line_no_of "" ../../galactic-armada/src/main/utils/text-utils.asm:load-text-font}}
{{#include ../../galactic-armada/main/utils/text-utils.asm:load-text-font}}
```
