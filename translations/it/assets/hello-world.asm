; ANCHOR: dummy      le linee che iniziano con ANCHOR o ANCHOR_END sono usate da mdBook <https://rust-lang.github.io/mdBook/format/mdbook.html#including-portions-of-a-file>
; ANCHOR_END: dummy  queste linee sono rimosse dalla versione mostrata online
; ANCHOR: basics
...
SECTION "Header", ROM0[$100]
	...
	ds $150 - @, 0 ; lascia dello spazio per l'header

EntryPoint:
	; spegni il circuito audio
	ld a, 0
	ld [rNR52], a
; ANCHOR_END: basics

	; aspetta fino a VBlank prima di spegnere lo schermo
WaitVBlank:
	ld a, [rLY]
	cp 144
	jp c, WaitVBlank
...
CopyTilemap:
	...
	; inizializza i registri del display nel primo frame (vuoto)
; ANCHOR: bgp_write
	ld a, %11100100
	ld [rBGP], a
